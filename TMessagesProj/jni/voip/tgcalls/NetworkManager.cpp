...
#include "ZapretPacketSocketWrapper.h"
...
void NetworkManager::start() {
    _socketFactory = std::make_unique<zapret_internal::WrappedPacketSocketFactory>(
        std::make_unique<rtc::BasicPacketSocketFactory>(_thread->socketserver()));
