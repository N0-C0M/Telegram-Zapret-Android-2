...
void setZapretConfig(JNIEnv *env, jclass c, jboolean enabled, jboolean applyToMessages, jboolean applyToCalls, jstring config) {
    ...
    zapret::UpdateNativeConfig(enabled, applyToMessages, applyToCalls, configValue);
}
...
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_setZapretConfig", "(ZZZLjava/lang/String;)V", (void *) setZapretConfig},
