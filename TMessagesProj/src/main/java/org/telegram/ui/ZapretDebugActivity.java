...
public class ZapretDebugActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private int activeProfileRow;
    private int sourceRow;
    private int scopeRow;
    private int networkStateRow;
    private int callStateRow;
    ...
    private void updateRows() {
        ...
        runtimeRow = rowCount++;
        activeProfileRow = rowCount++;
        sourceRow = rowCount++;
        scopeRow = rowCount++;
        networkStateRow = rowCount++;
        callStateRow = rowCount++;
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.ZapretDebugTitle));
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            if (position == connectionTestRow) {
                ...
                openCallPicker();
            } else if (position == showLogRow) {
                showLogDialog();
            } else if (position == clearLogRow) {
                ZapretDiagnosticsController.getInstance().clearLog();
            }
        });
    ...
    private void showLogDialog() {
        ...
        builder.setNeutralButton(LocaleController.getString(R.string.ZapretDebugClearLog), (dialog, which) ->
            ZapretDiagnosticsController.getInstance().clearLog());
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public int getItemViewType(int position) {
            if (position == shadowRow) {
                return 0;
            } else if (position == statusHeaderRow || position == testsHeaderRow || position == logsHeaderRow) {
                return 2;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == runtimeRow) {
                    ...
                    } else if (position == activeProfileRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretBuiltInStrategy), ZapretConfig.getActiveConfigDisplayName(), true);
                    } else if (position == sourceRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretConfigurationSource), ZapretConfig.getCurrentSourceTitle(), true);
                    } else if (position == scopeRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretScope), ZapretConfig.getScopeTitle(), true);
                    } else if (position == networkStateRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretDebugNetworkState), ZapretDiagnosticsController.getInstance().getSelectedConnectionStateSummary(), true);
                    } else if (position == callStateRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretDebugCallState), ZapretDiagnosticsController.getInstance().getCurrentCallStateSummary(), true);
                    } else if (position == rotationRow) {
                        cell.setTextAndValue(LocaleController.getString(R.string.ZapretDebugRotationState), ZapretDiagnosticsController.getInstance().getRotationSummary(), false);
                        ...
                        cell.setText(LocaleController.getString(R.string.ZapretDebugShowLog), true);
                    } else if (position == clearLogRow) {
                        cell.setCanDisable(true);
                        cell.setTextColor(Theme.getColor(Theme.key_text_RedRegular));
                        cell.setText(LocaleController.getString(R.string.ZapretDebugClearLog), false);
                    }
                    break;
                }
                case 2: {
                    ...
                    if (position == statusHeaderRow) {
                        headerCell.setText(LocaleController.getString(R.string.ZapretDebugStatusSection));
                    } else if (position == testsHeaderRow) {
                        headerCell.setText(LocaleController.getString(R.string.ZapretDebugTestsSection));
                    } else if (position == logsHeaderRow) {
                        headerCell.setText(LocaleController.getString(R.string.ZapretDebugLogSection));
                    }
                    break;
                }
                case 4: {
                    TextInfoPrivacyCell infoCell = (TextInfoPrivacyCell) holder.itemView;
                    infoCell.setText(ZapretDiagnosticsController.getInstance().getOverviewText());
