...
public class DataSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private int zapretSectionRow;
    private int zapretRow;
    private int zapretSection2Row;
...
//        quickRepliesRow = rowCount++;
        ...
        zapretSectionRow = rowCount++;
        zapretRow = rowCount++;
        zapretSection2Row = rowCount++;
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            } else if (position == zapretRow) {
                presentFragment(new ZapretSettingsActivity());
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == useLessDataForCallsRow) {
                        ...
                        textCell.setIcon(0);
                        textCell.setTextAndValue(LocaleController.getString(R.string.ZapretTitle), ZapretConfig.getSettingsSummary(), false);
                    } else if (position == resetDownloadRow) {
                        textCell.setIcon(0);
                ...
                case 2: {
                    ...
                    } else if (position == zapretSectionRow) {
                        headerCell.setText(LocaleController.getString(R.string.ZapretTitle));
        ...
        public boolean isRowEnabled(int position) {
            return position == mobileRow || position == roamingRow || position == wifiRow || position == storageUsageRow || position == useLessDataForCallsRow || position == dataUsageRow || position == proxyRow || position == zapretRow || position == clearDraftsRow ||
        ...
        public int getItemViewType(int position) {
            if (position == mediaDownloadSection2Row || position == usageSection2Row || position == callsSection2Row || position == proxySection2Row || position == zapretSection2Row || position == autoplaySectionRow || position == clearDraftsSectionRow || position == saveToGalleryDividerRow) {
                return 0;
            } else if (position == mediaDownloadSectionRow || position == streamSectionRow || position == callsSectionRow || position == usageSectionRow || position == proxySectionRow || position == zapretSectionRow || position == autoplayHeaderRow || position == saveToGallerySectionRow) {
                return 2;
