...
public class NotificationCenter {
    ...
    public static final int messagesDeletedByPeer = totalEvents++;
    ...
    public static final int zapretSettingsChanged = totalEvents++;
    public static final int zapretDebugStateChanged = totalEvents++;
    public static final int zapretVpnStateChanged = totalEvents++;
